...
# Hint1: ne trebuie 2 variabile in care sa stocam datele introduse prima data de la tastatura.
# Hint2: trebuie comparate datele introduse anterior cu noile date.
# Hint3: putem folosit nested if else sau operatori logici. 
